...
void forward() {
  ...
  if (current_millis - previous_millis >= 1560) {
    if (test) pr_s("Forward--------------------------------");
    if (test) pr_s(current_millis);
...
/**
  Beautiful print for first line output
  @param None
  @return None
*/
...
/**
  Beautiful print for matrix output with indexes of elements
  @param None
  @return None
*/
...
/**
  Beautiful print for matrix output without of elements
  @param None
  @return None
*/
...
/**
  Beautiful print for BIG matrix output with indexes of elements
  @param None
  @return None
*/
void show_matrix2(int matrix[NUM_ROWS + 2][NUM_COLUMNS + 2]) {
  if (beautiful_output) ind_first_line();
...
void loop() {
  ...
  if (calc_distance() < 25) {
    ...
    add_poundary(path_poundary, path);
    if (test) show_matrix2(path_poundary);
